...
/obj/mecha/working/ripley/atom_init()
	. = ..()
	AddComponent(/datum/component/examine_research, DEFAULT_ROBOT_CONSOLE_ID, 1200, DIAGNOSTIC_EXTRA_CHECK)
...
/obj/mecha/working/ripley/firefighter/atom_init()
	. = ..()
	AddComponent(/datum/component/examine_research, DEFAULT_ROBOT_CONSOLE_ID, 1400, DIAGNOSTIC_EXTRA_CHECK)
...
/obj/mecha/working/ripley/recycle_ripley/atom_init()
	. = ..()
	AddComponent(/datum/component/examine_research, DEFAULT_ROBOT_CONSOLE_ID, 100, DIAGNOSTIC_EXTRA_CHECK)
