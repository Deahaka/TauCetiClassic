...
/obj/machinery/bot/medbot/mysterious/atom_init()
	...
	AddComponent(/datum/component/examine_research, DEFAULT_ROBOT_CONSOLE_ID, 1000, DIAGNOSTIC_EXTRA_CHECK)
...
/obj/machinery/bot/medbot/atom_init()
	...
	AddComponent(/datum/component/examine_research, DEFAULT_ROBOT_CONSOLE_ID, 400, DIAGNOSTIC_EXTRA_CHECK)
	return INITIALIZE_HINT_LATELOAD
