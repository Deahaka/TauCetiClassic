...
/proc/explosion(turf/epicenter, devastation_range, heavy_impact_range, light_impact_range, flash_range, adminlog = 1, z_transfer = 1, make_hole = TRUE)
	set waitfor = FALSE
	...
	explosion_rec(epicenter, power, make_hole)
	return
