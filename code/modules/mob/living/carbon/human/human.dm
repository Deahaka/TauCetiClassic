...
/mob/living/carbon/human
	...
	hud_possible = list(HEALTH_HUD, STATUS_HUD, ID_HUD, WANTED_HUD, IMPLOYAL_HUD, IMPCHEM_HUD, IMPTRACK_HUD, IMPMINDS_HUD, ANTAG_HUD, HOLY_HUD, GOLEM_MASTER_HUD, BROKEN_HUD, ALIEN_EMBRYO_HUD, IMPOBED_HUD, NANITE_HUD, DIAG_NANITE_FULL_HUD)
	w_class = SIZE_HUMAN
	//icon_state = "body_m_s"
...
/mob/living/carbon/human/vomit(punched = FALSE, masked = FALSE, vomit_type = DEFAULT_VOMIT, blood = FALSE, stun = TRUE, force = FALSE)
	var/mask_ = masked
	...
	return ..(punched, mask_, vomit_type, blood, stun, force)
